export function initMinimap() {
    ...
    if (minimapContainer && thumbs.length > 0) {
        const textLabels = [
            { text: 'Interiores', insertBeforeIndex: 0 },
            { text: 'Exteriores', insertBeforeIndex: 5 },
            { text: 'Aéreas', insertBeforeIndex: 10 },
            {
                text: 'Ver todo',
                isSectionLink: true,
                targetSelector: '#all-work',
                children: [
                    { text: 'Renders', href: '/es/proyectos/renders/' },
                    { text: 'Animaciones', href: '/es/proyectos/animaciones/' },
                    { text: '360°', href: '/es/proyectos/360/' }
                ]
            }
        ];
