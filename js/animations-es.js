...
const DEFAULT_VIDEO_DESCRIPTION = 'Animación arquitectónica de Arqing para pantallas digitales, presentaciones y video marketing.';
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    function hydratePlayer({ autoplay = false, force = false } = {}) {
        ...
        cinemaEmbed.title = `Reproductor de video: ${video.title}`;
